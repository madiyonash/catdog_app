...
The web app was developed using the `flask` package in Python. Our initial approach involved using `shiny`, but due to the greater documentation for `flask` than `shiny` in Python, we switched approaches and this became our **purr**eference.
